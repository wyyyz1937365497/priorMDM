...
def double_take_arb_len(blend_len,handshake_size, diffusion, model, model_kwargs, n_frames, eval_mode=False):
    ...
    old_guidacnce_param = guidance_param
    ...
    double_take_sample = sample_fn(
            ...
            clip_denoised=False,
            model_kwargs=model_kwargs,
            skip_timesteps=100 if not debug else 998,  # 0 is the default value - i.e. don't skip any step
    ...
    guidance_param = old_guidacnce_param
